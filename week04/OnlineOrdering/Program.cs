...
class Program
{
    static void Main(string[] args)
    {
        ...
        Order order1 = new Order(new Customer("John Doe", "271 R. Yolanda Ramiro Brilho", "São Pedro", "SP", 13520-000, "Brasil"));
        order1.GetProduct(new Product("Product A", 480320, 99.99, 3));
        order1.GetProduct(new Product("Product B", 480325, 50.50, 2));
        orders.Add(order1);

        Order order2 = new Order(new Customer("Jane Doe", "123 Main St", "Springfield", "IL", 62701, "USA"));
